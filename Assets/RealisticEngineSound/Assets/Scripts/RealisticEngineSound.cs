...
public class RealisticEngineSound : MonoBehaviour 
{
    ...
    private void Start()
    {
        ...
        if (Camera.main != null)
        {
            if (Vector3.Distance(Camera.main.transform.position, gameObject.transform.position) <= maxDistance)
            {
                isCameraNear = true;
    ...
    void CreateIdle()
    {
        if (idleClip != null)
        {
            ...
            engineIdle.ignoreListenerPause = false;
            engineIdle.ignoreListenerVolume = false;
            engineIdle.Play();
            if (audioMixer != null)
    ...
    void CreateLowOff()
    {
        if (lowOffClip != null)
        {
            ...
            lowOff.loop = true;
            lowOff.ignoreListenerPause = false;
            lowOff.ignoreListenerVolume = false;
            lowOff.Play();
            if (audioMixer != null)
    ...
    void CreateLowOn()
    {
        if (lowOnClip != null)
        {
            ...
            lowOn.loop = true;
            lowOn.ignoreListenerPause = false;
            lowOn.ignoreListenerVolume = false;
            lowOn.Play();
            if (audioMixer != null)
    ...
    void CreateMedOff()
    {
        if (medOffClip != null)
        {
            ...
            medOff.loop = true;
            medOff.ignoreListenerPause = false;
            medOff.ignoreListenerVolume = false;
            medOff.Play();
            if (audioMixer != null)
    ...
    void CreateMedOn()
    {
        if (medOnClip != null)
        {
            ...
            medOn.loop = true;
            medOn.ignoreListenerPause = false;
            medOn.ignoreListenerVolume = false;
            medOn.Play();
            if (audioMixer != null)
    ...
    void CreateHighOff()
    {
        if (highOffClip != null)
        {
            ...
            highOff.loop = true;
            highOff.ignoreListenerPause = false;
            highOff.ignoreListenerVolume = false;
            highOff.Play();
            if (audioMixer != null)
    ...
    void CreateHighOn()
    {
        if (highOnClip != null)
        {
            ...
            highOn.loop = true;
            highOn.ignoreListenerPause = false;
            highOn.ignoreListenerVolume = false;
            highOn.Play();
            if (audioMixer != null)
    ...
    void CreateRPMLimit()
    {
        if (maxRPMClip != null)
        {
            ...
            maxRPM.loop = true;
            maxRPM.ignoreListenerPause = false;
            maxRPM.ignoreListenerVolume = false;
            maxRPM.Play();
            if (audioMixer != null)
    ...
    void CreateReverse()
    {
        if (reversingClip != null)
        {
            ...
            reversing.loop = true;
            reversing.ignoreListenerPause = false;
            reversing.ignoreListenerVolume = false;
            reversing.Play();
            if(audioMixer != null)
