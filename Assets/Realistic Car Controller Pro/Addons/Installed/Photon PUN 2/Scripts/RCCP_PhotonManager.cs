...
public class RCCP_PhotonManager : MonoBehaviourPunCallbacks {
    ...
    private void ConnectToServer() {
        ...
        if (RCCP_UI_Informer.Instance)
            RCCP_UI_Informer.Instance.Display("Connecting to server");
    ...
    public override void OnConnectedToMaster() {
        ...
        if (RCCP_UI_Informer.Instance)
            RCCP_UI_Informer.Instance.Display("Connected to server, Entering to lobby");
    ...
    public override void OnJoinedRoom() {
        ...
        if (RCCP_UI_Informer.Instance)
            RCCP_UI_Informer.Instance.Display("Joined room, You can spawn your vehicle from 'Options' menu");
    ...
    public override void OnCreatedRoom() {
        ...
        if (RCCP_UI_Informer.Instance)
            RCCP_UI_Informer.Instance.Display("Created room, You can spawn your vehicle from 'Options' menu");
    ...
    private void UpdateRoomListView(List<RoomInfo> roomList) {
        ...
        foreach (RoomInfo info in cachedRoomList.Values) {
            ...
            entry.GetComponent<RCCP_PhotonUIRoom>().Check(info.Name, info.PlayerCount.ToString() + " / " + info.MaxPlayers.ToString());
    ...
    public void RPCChat(string nickName, string text) {
        ...
        RCCP_PhotonUIChatLine newChatLine = Instantiate(chatLinePrefab.gameObject, chatLinesContent.transform).GetComponent<RCCP_PhotonUIChatLine>();
        newChatLine.Line(nickName + " : " + text);

        RCCP_PhotonUIChatLine[] chatLines = chatLinesContent.GetComponentsInChildren<RCCP_PhotonUIChatLine>();
